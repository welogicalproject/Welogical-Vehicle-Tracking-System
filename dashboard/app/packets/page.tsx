      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          <button
            ...
            disabled={refreshing}
            className="w-full md:w-auto flex items-center justify-center gap-2 bg-[#1e294b] hover:bg-[#2e3b5e] disabled:opacity-50 text-white font-medium text-sm px-4 py-2 rounded-lg transition-colors border border-[#3b4b72]"
          >
