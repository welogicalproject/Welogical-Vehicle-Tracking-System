  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-[#131a2d]/40 border border-[#1e294b]/60 rounded-xl px-4 py-3">
      <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
        <div className="relative w-full sm:w-auto">
          <button
            ...
            className="bg-[#131a2d] hover:bg-[#1e294b] border border-[#1e294b] rounded-lg px-4 py-2 text-xs font-semibold text-white flex items-center justify-between gap-3 w-full sm:w-56 transition-all"
          >
          ...
          {vehicleDropdownOpen && (
            <div className="absolute top-11 left-0 w-full sm:w-64 bg-[#0f172a] border border-[#1e294b] rounded-xl shadow-2xl z-[1000] p-1.5 space-y-0.5 animate-in fade-in duration-200">
              <button
        ...
        <div className="relative w-full sm:w-auto">
          <button
            ...
            className="bg-[#131a2d] hover:bg-[#1e294b] border border-[#1e294b] rounded-lg px-4 py-2 text-xs font-semibold text-white flex items-center justify-between gap-3 w-full sm:w-48 transition-all"
          >
            <span className="flex items-center gap-2">
          ...
          {rangeDropdownOpen && (
            <div className="absolute top-11 left-0 w-full sm:w-48 bg-[#0f172a] border border-[#1e294b] rounded-xl shadow-2xl z-[1000] p-1.5 space-y-0.5 animate-in fade-in duration-200">
        ...
        <button
          onClick={onRefresh}
          disabled={refreshing}
          className="w-full sm:w-auto flex items-center justify-center p-2 rounded-lg bg-[#131a2d] hover:bg-[#1e294b] border border-[#1e294b] text-slate-300 disabled:opacity-50 transition-all"
          title="Refresh Feed"
        >
      ...
      <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
        {range === "custom" && (
          <div className="flex flex-col sm:flex-row items-center gap-2 w-full sm:w-auto">
            <input
              ...
              className="w-full sm:w-auto h-8 rounded-lg border border-[#1e294b] bg-[#0b0f19] px-2 text-[10px] text-white focus:outline-none"
            />
            <input
              type="datetime-local"
              value={customEnd}
        ...
        <div className="w-full sm:w-auto justify-center flex items-center gap-2 bg-[#10b981]/10 border border-[#10b981]/20 px-3 py-1.5 rounded-lg text-xs font-extrabold text-emerald-400">
